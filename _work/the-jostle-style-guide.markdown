...
<div class="mw-900  bp1-u-textAlign-center  u-mar-auto  u-mar-b05">
    ...
    <p class="as-h3" style="max-width: 100%;">Alongside the Design Team at Jostle, I helped create The Jostle Style Guide(Style Guide)—a design system that enables us to create, replicate, and assemble consistently.</p>
