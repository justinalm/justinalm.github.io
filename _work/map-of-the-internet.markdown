...
---
<article>
	<div class="vh-100 dt w-100 bg-black pt5 pb6 ph4 bb b--black-10" style="background:url(/uploads/peer1-map-of-the-internet-cover.jpg) no-repeat center; background-size: cover;">
    	<div class="dtc v-mid">
      		<h1 class="fl f1 f-subheadline-l measure lh-title fw7 mb0 bg-white pt1 pb2 ph3 ph4-l shadow-2">Map of the Internet</h1>
      		<p class="fl cl measure f5 lh-copy i bg-white pa0 ph2 shadow-2">UI/UX, iOS, Android</p>
    	</div>
	</div>
